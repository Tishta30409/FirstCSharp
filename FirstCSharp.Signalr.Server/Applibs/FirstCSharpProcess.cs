...
namespace FirstCSharp.Signalr.Server.Applibs
{
    ...
    {
        private static ILogger logger = LogManager.GetLogger("FirstCSharp.Signalr.Server");

        public static void ProcessStart()
        {
            logger.Info("FirstCSharp.Signalr.Server Application_Start");
            ...
            logger.Info("FirstCSharp.Signalr.Server Started");
        }

        public static void ProcessStop()
        {
            logger.Info("FirstCSharp.Signalr.Server Ended");
        }
    }
}
